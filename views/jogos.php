...
<header>
    ...
    <main>
        <section id="ps3">
            <h2>playstation 3</h2>
            <ul class="jogos" id="jogos_ps3">
                <?php
                    $sql = "SELECT id, nome, descricao, preco, img FROM tbitens WHERE tipo = 'game playstation 3';";
                    $result = $db->query($sql);
        ...
        <section id="ps4">
            <h2>playstation 4</h2>
            <ul class="jogos" id="jogos_ps4">
                <?php
                    $sql = "SELECT id, nome, descricao, preco, img FROM tbitens WHERE tipo = 'game playstation 4';";
                    $result = $db->query($sql);
        ...
        <section id="ps5">
            <h2>playstation 5</h2>
            <ul class="jogos" id="jogos_ps5">
                <?php
                    $sql = "SELECT id, nome, descricao, preco, img FROM tbitens WHERE tipo = 'game playstation 5';";
                    $result = $db->query($sql);
